# Godot Engine documentation (w/ PreTeXt)
...
There are also scripts to make a [PreTeXt](https://pretextbook.org) version of the book. For info open the [Pretext README file](pretext/README.MD)
